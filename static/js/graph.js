...
(function() {
  window.Graph || (window.Graph = function() {
    var background_color, backward_select_color, edge_line_color, forward_select_color, init_edge_preview_graph, init_main_graph, load_connections, mouseover_color;
    ...
    init_main_graph = function() {
      ...
      cy.on('select', function(ev) {
        ...
        cy.$("edge[source=\"" + iid + "\"]").css({
          'line-color': forward_select_color
        });
        return cy.$("edge[target=\"" + iid + "\"]").css({
          'line-color': backward_select_color
        });
      });
    ...
    return init_edge_preview_graph = function() {
      var cy;
      cy = cytoscape({
