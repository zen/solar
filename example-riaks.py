...
def setup_riak():
    ...
    # riak_cluster_service = vr.create('riak_cluster_service1',
    #                                  'resources/riak_cluster', {})[0]

    # signals.connect(node1, riak_cluster_service)

    # for riak in riak_services:
    #     signals.connect(riak, riak_cluster_service, {'riak_name': 'nodes'})

    # riak_joiner_service = vr.create('riak_joiner_service1',
    #                                 'resources/riak_joiner', {})[0]

    # signals.connect(node1, riak_joiner_service)
    # signals.connect(riak_services[0], riak_joiner_service, {'riak_name': 'join_to'})
